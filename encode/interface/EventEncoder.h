...
class EncodedEvent
{
    ...
    public:
        ...
        bool eventFinished(){return chip_iterator == chip_matrices.end();}
        void clear();
...
class EventEncoder
{
    ...
    public:
        ...
        void get_next_event(EncodedEvent* encoded_event, bool pDoSingle = false);
        //EncodedEvent* get_single_module_event(uint32_t pEventId, ChipIdentifier pModuleId);
        void get_single_module_event(EncodedEvent* encoded_event, uint32_t pEventId, ChipIdentifier pModuleId);
        uint32_t getEvent_id() {return event_id;}
